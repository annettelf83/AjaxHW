document.addEventListener('DOMContentLoaded', () => {
	let suggestedTopics = ['Slavoj Žižek', 'Stephen Hawking', 'Richard Dawkins', 'Carl Sagan', 'Albert Einstein', 'Julian Assange', 'Edward Snowden'];
	const queryLimit = 9;
	const featuredQuery = "https://api.giphy.com/v1/gifs/trending?api_key=ujcgsl89rkhK6NyzvU1qhkeMFdEcr8QR";
	const searchQuery = "https://api.giphy.com/v1/gifs/search?api_key=ujcgsl89rkhK6NyzvU1qhkeMFdEcr8QR";
